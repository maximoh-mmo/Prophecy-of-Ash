...
public class ProphecyOfAsh : ModuleRules
{
	public ProphecyOfAsh(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "EnhancedInput", "GameplayAbilities", "GameplayTags", "GameplayTasks", "FMODStudio", "AIModule", "NavigationSystem"});
